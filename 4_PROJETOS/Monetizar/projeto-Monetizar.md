# 📜 Histórico — Projeto Monetizar

> Este arquivo documenta a transição do projeto "Monetizar" para "Saberes de Coração".
...
O projeto classificava conteúdos em:

### Espírito (Conhecimento Gnóstico)
- kundalini → espirito/gnose
- pneuma → espirito/gnose
- siteGnostico → espirito/gnose
- helena-blavatsky → espirito/teosofia
- oTaoOuDao → espirito/teosofia

### Jornada (Transformação)
- jornadaConsciencia → jornada/consciencia
...
- 💚 Conhecimento **livre** — não é vendido
- 🖤 Compartilhado **de coração** — sem expectativa de retorno
- 🌟 Objetivo: **elevar o campo** coletivo
