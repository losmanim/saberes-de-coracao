...
// Estatísticas finais
$countSaberes = $db->fetchOne("SELECT COUNT(*) as total FROM saberes")->total;
$countCategorias = $db->fetchOne("SELECT COUNT(*) as total FROM categorias")->total;
$countPraticas = $db->fetchOne("SELECT COUNT(*) as total FROM praticas")->total;
$countConexoes = $db->fetchOne("SELECT COUNT(*) as total FROM conexoes")->total;
